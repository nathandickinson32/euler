...
(describe "Euler Problem 3"
  ...
  (context "euler-3"
    ...
    (it "gets highest prime factorial for n"
      ...
      (should= 9009 (* 3 3 7 11 13))
      ;(should= 13 (euler-3 9009))
      ;(should= 11 (euler-3 (/ 9009 13)))
      ;(should= 7 (euler-3 (/ 9009 13 11)))
      ;(should= 3 (euler-3 (/ 9009 13 11 7)))
      ;(should= 3 (euler-3 (/ 9009 13 11 7 3)))
